...
export const COIN_SHOP_ITEMS = [
  { id: 'scout-pack', name: 'Scout Pack', icon: 'i-bag', cost: 2200, currency: 'coins', blurb: 'Unlocks Scout badge + Salute emote. Cosmetic only — equip in Locker.', grants: { badge: 'scout', emote: 'salute' } },
  { id: 'slate-skin', name: 'Slate Skin', icon: 'i-mask', cost: 3400, currency: 'coins', blurb: 'Grey body paint + Slate Pulse kit (19 dmg / 170ms). Slightly faster than default Pulse when Pulse frame is equipped.', grants: { skin: 'slate' } },
  { id: 'amber-skin', name: 'Amber Skin', icon: 'i-mask', cost: 4200, currency: 'coins', blurb: 'Gold body paint + Amber Shot kit (20 dmg / 190ms). Heavier hits, a bit slower fire than Pulse.', grants: { skin: 'amber' } },
  { id: 'dust-trail', name: 'Dust Trail', icon: 'i-sparkle', cost: 1800, currency: 'coins', blurb: 'Soft grey grit trail behind you while moving. Look only — no speed or damage change.', grants: { trail: 'dust' } },
  { id: 'matte-gun', name: 'Matte Finish', icon: 'i-sword', cost: 2600, currency: 'coins', blurb: 'Flat steel-grey coat on your gun model. Cosmetic finish — does not change fire rate or damage.', grants: { gunSkin: 'matte' } },
  { id: 'steel-rounds', name: 'Steel Rounds', icon: 'i-target', cost: 2100, currency: 'coins', blurb: 'Grey/bronze bullet look. Cosmetic projectile skin — same damage and travel speed.', grants: { bulletSkin: 'steel' } },
  { id: 'grinder-title', name: 'GRINDER Title', icon: 'i-medal', cost: 5000, currency: 'coins', blurb: 'Shows “GRINDER” under your name in lobby & results. Flex only — no combat bonus.', grants: { title: 'grinder' } },
];

export const GEM_SHOP_ITEMS = [
  { id: 'crate', name: 'Mystery Crate', icon: 'i-crate', cost: 280, currency: 'gems', blurb: 'Opens one random locked locker item you do not own. If you already own everything, refunds 80 gems.', grants: 'random' },
  { id: 'royal-skin', name: 'Royal Skin', icon: 'i-mask', cost: 2200, currency: 'gems', blurb: 'Violet paint + Royal Lance (24 dmg / 160ms, +5% move). Strong mid-range when Pulse frame is on.', grants: { skin: 'royal' } },
  { id: 'void-skin', name: 'Void Skin', icon: 'i-mask', cost: 2800, currency: 'gems', blurb: 'Dark paint + Void Pierce (26 dmg / 210ms, +8% move). Hard-hitting, slower cadence.', grants: { skin: 'void' } },
  { id: 'prism-skin', name: 'Prism Skin', icon: 'i-mask', cost: 3200, currency: 'gems', blurb: 'Pink paint + Prism Spray (21 dmg / 130ms, +10% move). Fastest skin kit — more spread, more volume.', grants: { skin: 'prism' } },
  { id: 'comet-trail', name: 'Comet Trail', icon: 'i-sparkle', cost: 1400, currency: 'gems', blurb: 'Bright violet motion streak. Cosmetic trail only — equip in Locker → Trail.', grants: { trail: 'comet' } },
  { id: 'eclipse-trail', name: 'Eclipse Trail', icon: 'i-sparkle', cost: 1800, currency: 'gems', blurb: 'Thick near-black trail. Cosmetic only — no combat effect.', grants: { trail: 'eclipse' } },
  { id: 'obsidian-gun', name: 'Obsidian Coat', icon: 'i-sword', cost: 1600, currency: 'gems', blurb: 'Near-black gun finish. Look only — stats come from your Frame / Skin, not this coat.', grants: { gunSkin: 'obsidian' } },
  { id: 'goldleaf-gun', name: 'Goldleaf Coat', icon: 'i-sword', cost: 2100, currency: 'gems', blurb: 'Gold accent gun finish. Cosmetic coat — no damage or fire-rate change.', grants: { gunSkin: 'goldleaf' } },
  { id: 'crystal-rounds', name: 'Crystal Rounds', icon: 'i-target', cost: 1500, currency: 'gems', blurb: 'Purple/pink crystal projectiles. Visual only — same hit rules as stock rounds.', grants: { bulletSkin: 'crystal' } },
  { id: 'singularity-rounds', name: 'Singularity Rounds', icon: 'i-target', cost: 2400, currency: 'gems', blurb: 'Black + lime projectile look (slightly larger glow). Cosmetic only.', grants: { bulletSkin: 'singularity' } },
  { id: 'carbine-frame', name: 'Carbine Frame', icon: 'i-sword', cost: 2600, currency: 'gems', blurb: 'Replaces your gun kit: 21 dmg / 155ms, tight spread, fast rounds. Overrides skin weapon stats while equipped.', grants: { gun: 'carbine' } },
  { id: 'shotty-frame', name: 'Shotty Frame', icon: 'i-sword', cost: 3000, currency: 'gems', blurb: 'Replaces your gun kit: 32 dmg / 520ms, wide spread, slow bolts. Close-range burst — overrides skin weapon.', grants: { gun: 'shotty' } },
  { id: 'crown-emote', name: 'Crown Emote', icon: 'i-wand', cost: 900, currency: 'gems', blurb: 'Press E in-match to flash the Crown emote above your head. Taunt only.', grants: { emote: 'crown' } },
  { id: 'elite-badge', name: 'Elite Badge', icon: 'i-medal', cost: 1200, currency: 'gems', blurb: 'Elite status chip beside your name in lobby lists. Cosmetic prestige — no ranked boost.', grants: { badge: 'elite' } },
  { id: 'sovereign-title', name: 'SOVEREIGN Title', icon: 'i-trophy', cost: 3500, currency: 'gems', blurb: 'Rare “SOVEREIGN” title under your name. Display flair only.', grants: { title: 'sovereign' } },
  { id: 'mythic-title', name: 'MYTHIC Title', icon: 'i-star', cost: 4200, currency: 'gems', blurb: 'Rarest shop title — “MYTHIC” under your name. Pure flex, zero combat effect.', grants: { title: 'mythic' } },
];
